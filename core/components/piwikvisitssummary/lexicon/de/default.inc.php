...
$_lang['piwikvisitssummary.settings_not_found'] = 'Die Piwik-Systemeinstellungen sind leer. Bitte stellen Sie sicher, dass die Felder piwikvisitssummary.protocol, piwikvisitssummary.url, piwikvisitssummary.siteid und piwikvisitssummary.token_auth in den MODX-Systemeinstellungen ausgefüllt sind.';
...
$_lang['setting_piwikvisitssummary.url_desc'] = 'Bitte geben Sie die URL der Piwik-Installation ohne Protokoll ein. Die URL muss mit einem Schrägstrich (Slash) abschließen!';
...
$_lang['setting_piwikvisitssummary.token_auth_desc'] = 'Bitte geben Sie den Token Auth eines Piwik-Benutzers mit Ansicht-Zugriff für die angegebene Site-ID ein.';
...
$_lang['setting_piwikvisitssummary.password_desc'] = 'Bitte geben Sie das MD5-codierte Passwort ihres Piwik-Benutzers mit Ansicht-Zugriff für die angegebene Site-ID ein. Bitte leer lassen, wenn der Link zur Gesamtstatistik nicht ausgegeben werden soll.';
